...
//LINHAS E COLUNAS
 ...
 //TRANSFORMANDO EM A RAIZ EM UM NUMERO INTEIRO PARA DEPOIS EFETUAR A
//COMPARACAO
 ...
 //FAZENDO A COMPARACCAO ENTRE A RAIZ E O NUMORO INTEIRO TIRADO A PARTIR
//DELA, SE FOREM DIFERENTES A RAIZ NAO É UM NUMERO INTEIRO, LOGO A MATRIZ NAO É QUADRADA
 if(calc != calc2){
 ...
 /*QUADRADO
Matematicamente, um Quadrado Mágico é uma matriz quadrada (mesmo número de
linhas e colunas)
de ordem n (n linhas e n colunas) cujos elementos (números naturais) variam
sucessivamente
de 1 até n.n(nxn) que são arrumados de modo que a soma de cada linha,
cada umas das duas diagonais principais ou de cada coluna seja sempre uma
constante.
*/
var matriz = [];
var somad = 0;
